...
현재 `0.1.0`은 checksum-pinned GitHub Release와 GitHub Packages에 배포되는
...
```sh
npm install https://github.com/menaje/dwg-viewer/releases/download/viewer-core-v0.1.0/menaje-viewer-render-protocol-0.1.0.tgz
```

GitHub Packages를 사용할 때는 `@menaje` scope를
`https://npm.pkg.github.com`에 연결하고 exact `0.1.0`을 설치합니다.
