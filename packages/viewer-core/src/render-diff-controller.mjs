...
export class ViewerRenderDiffController {
  ...
  snapshot() {
    ...
    return Object.freeze({
      ...
      payloadBytes: delta.payloadBytes,
      overlayEntries: delta.overlayEntries,
      checkpointRecommended: delta.checkpointRecommended,
      affectedWorldBounds: delta.affectedWorldBounds,
      invalidatedDependencyIds: delta.invalidatedDependencyIds,
