...
한글 레이어·블록·문자 때문에 Webview 열기가 중단되지 않습니다. 남은
엔티티 계열 및 정밀
...
11,172자 전체를 조합식으로 변환합니다. 코드 슬롯이 겹치는 국내 글꼴은
다음처럼 도면이 요청한 BigFont 이름별로 고정할 수 있고, 적용된 방식은
글꼴 패널에 표시됩니다.
...
Johab의 비한글 기호·한자는 아직 직접 Unicode 글리프 또는 시스템 글꼴
대체 경로를 사용합니다.
